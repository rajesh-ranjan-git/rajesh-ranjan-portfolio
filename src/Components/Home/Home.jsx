      ...
      <div className="home">
        <div className="jumbotron d-flex align-items-center" id="greetings">
          ...
          <div className="triangle triangle_1">
            <img src="src\assets\images\obj_triangle.png" alt="" />
          </div>
              ...
              <div className="row">
                <div className="col-md-7 home_header">
                  ...
                  <h1 className="heading_name">
                    I'M<strong className="main_name"> Rajesh Ranjan</strong>
                  </h1>
                  <div className="Typewriter__inline">
                    <div
                      className="Typewriter"
                      data-testid="typewriter-wrapper"
                    >
                      <span className="Typewriter__wrapper">Developer</span>
                  ...
                  <div className="social_media_div">
                    ...
                    >
                      <svg
                        ...
                        className="svg-inline--fa fa-github-alt "
                        role="img"
                    ...
                    >
                      <svg
                        ...
                        className="svg-inline--fa fa-stack-overflow "
                        role="img"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 384 512"
                      >
                  ...
                  <div className="button_container_1 download_resume_btn">
