  ...
  projects: [
    {
      ...
      summary:
        "BancardifyMe is a secure, feature-rich banking application built on the Horizon SaaS platform. It enables users to seamlessly connect multiple bank accounts, track real-time transactions, make peer-to-peer transfers, and manage their finances from one intuitive interface. The app combines robust security features with an easy-to-use design for effective financial management.",
      features: [
        "Multi-Account Integration: Connect and manage multiple bank accounts.",
        "Real-Time Transactions: Access live transaction data from linked accounts.",
        "Peer-to-Peer Transfers: Instant money transfers between users.",
        "Financial Insights: Track spending and visualize financial trends.",
        "Security & Scalability: Built with modern security practices and scalable architecture.",
        "Frontend: Next.js, TypeScript, TailwindCSS, ShadCN",
        "Backend: Appwrite (authentication, database), Plaid (banking integration), Dwolla (transactions)",
        "Form Handling and Validations: React Hook Form, Zod",
    ...
    },
    {
      ...
      google_play_link: null,
      summary:
        "GetKart is an e-commerce platform built with React and Vite, offering a seamless shopping experience with features like product search, filtering, sorting, and dynamic routing. It integrates user authentication with JWT and secure cookie storage, and employs Redux for state management. The site leverages modern UI design using Tailwind CSS, Shimmer UI, and DaisyUI, while ensuring performance optimization with lazy loading and debouncing.",
      features: [
        "Frontend: React, Vite, Tailwind CSS, DaisyUI, Remix-icons, Shimmer UI",
        "State Management: Redux, Context API",
        "User Authentication: JWT, Bcrypt for password encryption",
        "Forms & Validation: Formik, Yup",
        "Backend: MongoDB, Axios for API calls",
        "Key Functionalities: Search, Filtering, Sorting, Lazy Loading, Custom Hooks, Dynamic Routing, Infinite Scrolling",
      ],
      attribution: null,
      slides: [
        GetKart_Home_Page,
    ...
    },
    {
      ...
      filter: "filter-frontend",
      date: "26th July, 2017",
      github_link: "https://github.com/rajesh-ranjan-git/FQS-Painting.git",
      website_link: "https://rajesh-ranjan-git.github.io/FQS-Painting/",
      app_link: null,
      amazon_store: null,
      google_play_link: null,
      summary:
