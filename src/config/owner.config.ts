export const basicDetails = {
  ...
  description:
    "Full Stack Engineer specializing in modern web applications, AI-powered solutions, and scalable system architecture. Experienced in building production-grade applications with Next.js, React, Node.js, TypeScript, Python, and cloud technologies while optimizing performance, SEO, developer workflows, and user experience across enterprise and consumer platforms.",
...
export const internships = [
  {
    ...
    endMonth: "March",
    endYear: 2025,
    company: "CYBERED (Remote)",
    companyImage: "/assets/companies/cybered.webp",
    techStack: ["React Native", "Expo", "TypeScript", "Node JS", "REST APIs"],
    details: [
      {
        title: "Cross-Platform Mobile Development",
        description:
          "Built responsive Android experiences with React Native and Expo, developing reusable components, and API integrations.",
      },
      {
        title: "Performance & Feature Improvements",
        description:
          "Resolved 15+ UI issues and contributed to push notifications, OTA updates, and performance improvements.",
      },
    ],
  },
  {
...
export const experience = [
  {
    ...
    details: [
      {
        title: "Architecture & Platform Modernization",
        description:
          "Modernized Python-based services into a scalable Next.js architecture and upgraded Next.js 12 to 15, reducing cloud costs by ~30% and addressing 10+ security vulnerabilities.",
      },
      {
        title: "AI-Powered Content Intelligence",
        description:
          "Built AI workflows using OpenAI APIs and transformer-based NLP models to analyze 500K+ articles and power plagiarism, similarity detection, summarization, and content generation.",
      },
      {
        title: "Performance & SEO Optimization",
        description:
          "Improved SEO and Core Web Vitals through SSR, caching, lazy loading, and optimized APIs, reducing page rendering time from 3.7s to ~1.5s.",
      },
      {
        title: "API & Backend Optimization",
        description:
          "Optimized APIs, databases, and Python deployments, reducing unnecessary network calls by 40%+, backend resource usage by ~20%, and deployment time from 60 to 12 minutes.",
      },
      {
        title: "Product Development & Collaboration",
        description:
          "Built responsive interfaces, analytics features, integrations, and reusable components while collaborating with product, design, and engineering teams across Agile releases.",
      },
    ],
  },
    ...
    details: [
      {
        ...
        description:
          "Developed responsive web applications using React, JavaScript, and TypeScript with reusable architecture and consistent user experiences across devices.",
      },
      {
        title: "Reusable Components & Performance",
        description:
          "Created 20+ reusable React components and replaced resource-heavy dependencies with lightweight solutions to improve maintainability and application performance.",
      },
      {
        title: "API Integration & Optimization",
        description:
          "Integrated REST APIs and external services while optimizing loading behavior, responsive layouts, browser compatibility, and overall frontend performance.",
      },
    ],
  },
    ...
    details: [
      {
        ...
        description:
          "Reviewed audio, video, and in-game content against community standards to maintain safe, appropriate, and compliant digital experiences.",
      },
      {
        title: "Quality & Policy Compliance",
        description:
          "Evaluated content for policy violations, applied moderation guidelines, and maintained consistent quality standards across review workflows.",
      },
    ],
  },
    ...
    details: [
      {
        ...
        description:
          "Assisted users with service-related queries while maintaining clear communication and following established support processes.",
      },
      {
